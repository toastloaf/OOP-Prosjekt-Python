...
export class NPC {
    ...
    constructor(wealthchangeaccept, happinesschangeaccept, wealthchangedecline, happinesschangedecline) {
        this.wealthchange = wealthchangeaccept;
        this.happinesschange = happinesschangeaccept;
